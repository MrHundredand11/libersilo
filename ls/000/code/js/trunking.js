    ...
    fetch(zz)
        ...
        .then(data => {
            function gen_head(data) {                      
                ...
                hd_vw_c_2.innerHTML = "<select id='vw_vrs' class='hd_vw_c_vb' onchange='getVers(this)'><option value='vw_vrs_live' selected>LIVE</option><option value='vw_vrs_000'>V   0.0.0</option></select>";
