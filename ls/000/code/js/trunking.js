        ...
        case 'insc':
            ...
            switch (scion.insc_typ2) {
                ...
                case 'quot':
                    ...
                    insc_cntn.innerHTML = `<span class='bknd_01'>[</span>\t<span class='styl_insc_quot_wrds'>${scion.insc_cntn}</span>\t<span class='bknd_01'>]</span>`;
            ...
            switch (scion.insc_typ2) {
                case 'md_00':
                    ...
                    if (scion.cite_site !== undefined) {
                            var cite_site = gen_ECI('div', 'cite_site', `id_cite_site_${x}_${scion.scion_id}`);
